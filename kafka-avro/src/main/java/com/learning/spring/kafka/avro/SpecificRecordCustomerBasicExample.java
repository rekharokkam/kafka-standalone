...
@Slf4j
public class SpecificRecordCustomerBasicExample {

    public static void main(String[] args) {
        //Create SpecificRecord for Customer Basic
        ...
        try (DataFileWriter<CustomerBasic> dataFileWriter = new DataFileWriter<>(datumWriter)) {
            dataFileWriter.create(customerBasic.getSchema(), new File("customer-basic-specific-generated.avro"));
        ...
        //Read from a file
        final File basicCustomerFile = new File("customer-basic-specific-generated.avro");
